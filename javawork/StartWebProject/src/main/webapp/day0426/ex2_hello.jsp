...
%>
	<table class="table table-bordered" style="width: 400px;text-align: center;">
		<tr>
		...
		<tr>
			<td width="200" class="table-danger">취미</td>
			<td colspan="2">
				<%
	for(int i=0;i<hobby.length;i++){%> <%=hobby[i] %> <%}
	//for(String h :hooby){out.print("["+h+"]");}
	%>
			</td>
		</tr>
	</table>
