		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					...
					style="width: 130px;" value=<%=dto.getName() %>>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="license" value="있음" <%=String.valueOf(dto.getLicense()).equals("y")?"있음":"없음"%>>있음
					</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					style="width: 130px;" min="0" max="100" value="<%=dto.getJava()%>">
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					style="width: 130px;" min="0" max="100" value="<%=dto.getSpring()%>">
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					style="width: 130px;" min="0" max="100" value="<%=dto.getHtml()%>">
				</td>
			</tr>
			<tr>
