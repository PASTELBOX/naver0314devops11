...
public class ShopDao {
	...
	public List<ShopDto> getShopDatas()
	{
		...
		Connection conn=null;//'Connection' 개체는 데이터베이스에 대한 연결을 설정하는 데 사용됩니다.
		PreparedStatement pstmt=null;//SQL 쿼리를 실행하는 데 사용됩니다.
		ResultSet rs=null;//실행된 SQL 쿼리의 결과를 저장합니다.
