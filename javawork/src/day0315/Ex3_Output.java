...
public class Ex3_Output {
	...
	public static void main(String[] args) {
		...
		System.out.printf("평균:%3.1f점\n",avg);//%3.1 : 전체자리수 3자리(모자라도 상관없음),소숫점 이하 자리수 1자리
		System.out.printf("평균:%10.2f점\n",avg);//%10.2 : 전체자리수 10자리(남을경우 공백처리),소숫점 이후 자리수 2자리
		System.out.printf("평균:%-10.2f점\n",avg);//%-10.2 : 전체자리수 10자리(왼쪽으로 출격,남을경우 공백처리),소숫점 이후 자리수 2자리
