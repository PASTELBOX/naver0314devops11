...
public class Ex10_DateNumberFormat {
	...
	public static void main(String[] args) {
		...
		System.out.println(sdf1.format(date)); //2024-03-19 16:33:20 화
		
		SimpleDateFormat sdf2=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss EEEE");
		System.out.println(sdf2.format(date)); //2024-03-19 04:34:00 화요일
		
		SimpleDateFormat sdf3=new SimpleDateFormat("yyyy년 MM월 dd일 HH시 mm분");
		System.out.println(sdf3.format(date)); //2024-03-19 04:34:00 화요일
