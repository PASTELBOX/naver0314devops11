...
public class Ex9_DateCalendar {
	...
	public static void main(String[] args) {
		...
		int year=date.getYear()+1900;//년도는 1900이 빠진값으로 반환
		...
		System.out.println("Date를 이용하여 출력하기");
		System.out.println("현재년도 : "+year);
		System.out.println("현재월 : "+month);
		System.out.println("현재일 : "+day);
		System.out.println("현재요일 : "+week+"("+(week==0?"일":week==1?"월":week==2?"화":week==3?"수":week==4?"목":week==5?"금":"토")+")");
