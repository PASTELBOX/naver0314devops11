...
public class Ex5_ClientChat extends JFrame implements ActionListener,Runnable{
	...
	//메세지 전송 텍스트 필드와 전송 버튼을 처리하기 위한 메서드
	@Override
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub//
		Object ob=e.getSource();//이벤트가 발생한 소스
		
		//메세지입쳑창이거나 전송버튼일 경우 서버로 메세지 보내기
	...
	public void initDesign()
	{
		...
		btnConnect.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				String serverIp=JOptionPane.showInputDialog("접속한 서버 아이피를 입력하세요", "192.168.0.17");//접속할 서버 IP
				nickName=JOptionPane.showInputDialog("접속할 닉네임을 입력하세요", "민경진");//초기값은 각자 자기 이름으로
				...
				try {
					...
					//창제목 닉네임으로 변경
					Ex5_ClientChat.this.setTitle(nickName+"님의 채팅방");//창제목 변경
					//메세지도 변경
					...
					//서버로 "1|닉네임| 이 형태로 보낵
					pw.write("1|"+nickName+"\n");
					pw.flush();//flush를 해야 비로소 서버로 전생읻 된다
