...
-- insert : 일부만 추가할 경우 컬럼명기재, 전체 다 줄 경우 컬럼명 생략
...
-- 컬럼명 변경(mysql5은 change,mysql8은 rename column (오라클하고 같다)
-- hp->phone으로 변경해보자
...
-- 부분조회
select * from test01 limit 0,3; -- 첫데이터가 0번:0번부터3개 조회
...
insert into sawon values (null,'이하나',110,'여자','홍보부'); -- 에러 발생
-- check에 맞게 데이터를 추가하자
insert into sawon values (null,'이하나',90,'여자','홍보부');

insert into sawon values (null,'홍길동',87,'남','교육부'); -- 에러 발생
...
insert into sawon (name,score,gender,buseo) values ('박봉자',89,'여자','홍보부');
